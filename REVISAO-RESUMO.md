...
Revisão completa do `index.html` e `css/index.css` como desenvolvedor Front-End Sênior.
...
Criar `css/variables.css` para compartilhar entre todas as páginas:
```css
...
```bash
# CSS
npx cleancss -o css/index.min.css css/index.css
